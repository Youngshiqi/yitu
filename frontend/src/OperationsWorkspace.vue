...
import { Clock, Connection, DataAnalysis, Delete, Edit, Files, OfficeBuilding, Plus, Refresh, Setting, TrendCharts, Warning } from '@element-plus/icons-vue'
...
const nav = [{ id: 'overview', label: '运营概览', icon: DataAnalysis }, { id: 'exceptions', label: '异常工单', icon: Warning }, { id: 'fulfillment', label: '履约调度', icon: Connection }, { id: 'stations', label: '网点管理', icon: OfficeBuilding }, { id: 'sla', label: 'SLA 监控', icon: TrendCharts }, { id: 'knowledge', label: '知识库', icon: Files }, { id: 'deadletters', label: '死信队列', icon: Warning }, { id: 'retrieval', label: '检索验证', icon: Files }]
